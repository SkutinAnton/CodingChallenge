...
Examples:
[2, 4, 0, 100, 4, 11, 2602, 36]    return: 11 (the only odd number)

[160, 3, 1719, 19, 11, 13, -21]    return: 160 (the only even number)
*/


function findOutlier(integers){
    let arrOdd = integers.filter((num) => num % 2 !== 0);
    let arrEven = integers.filter((num) => num % 2 === 0);
